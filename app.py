    ...
    if col2.button("Gerar Mapa"):
        ...
        with col1:
            with st.spinner("Gerando mapa..."):
                folium.LayerControl(collapsed=False,position='topright',draggable=True).add_to(m) # TODO Terminar de ajustar e usar este padrão para ouros mapas
                Fullscreen().add_to(m)
    ...
    def adicionar_camadas(mapa: folium.Map, geojson_data: dict, tipo_filtrado: str = "todos"):
        ...
        for feature in features:
            try:
                ...
                #TODO Escolher se é melhor ou não com os Markers
